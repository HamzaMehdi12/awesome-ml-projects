...
| 📧 **YoloMine Object Detection Custom Model** | A custom YOLO-based object detection model implementation in **PyTorch** for **vehicle damage detection**, featuring a **DarkNet-style backbone**, **FPN neck**, and **multi-scale detection head**. | [Fraud_Detect_Sys](https://github.com/HamzaMehdi12/Object-Detection) |
